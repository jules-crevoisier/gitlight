  ...
  return (
    <>
      ...
      <div className="h-14 border-b border-zinc-200 dark:border-zinc-700 flex items-center justify-between px-6 lg:px-8 bg-white dark:bg-zinc-900 shrink-0">
        <h1 className="text-lg font-medium text-zinc-900 dark:text-zinc-100">Pull Requests</h1>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-8">
          {pullRequests.length === 0 ? (
            <div className="text-center py-12 border border-zinc-200 dark:border-zinc-600 rounded-lg bg-zinc-50/50 dark:bg-zinc-800/50">
              <Icon name="solar:git-pull-request-linear" size={48} className="text-zinc-300 dark:text-zinc-500 mx-auto mb-4" />
              <h3 className="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-1">No open pull requests</h3>
                  ...
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-[10px] font-mono bg-zinc-100 dark:bg-zinc-700 text-zinc-600 dark:text-zinc-300 px-1.5 py-0.5 rounded">
                          {pr.sourceBranch}
                        </span>
