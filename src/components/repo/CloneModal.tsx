    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg border border-zinc-200 shadow-xl w-full max-w-md mx-4 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-zinc-900">Clone repository</h2>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Icon name="solar:lock-linear" size={14} className="text-zinc-500" />
              <span className="text-sm font-medium text-zinc-700">HTTPS</span>
            </div>
            <div className="flex items-center gap-2">
              <input
                ...
                readOnly
                value={httpsUrl}
                className="flex-1 px-3 py-2 text-sm font-mono bg-zinc-50 border border-zinc-200 rounded-md"
              />
              <Button
                variant="secondary"
                size="sm"
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Icon name="solar:key-linear" size={14} className="text-zinc-500" />
              <span className="text-sm font-medium text-zinc-700">SSH</span>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="text"
          ...
          <div className="pt-4 border-t border-zinc-200">
            <p className="text-sm text-zinc-600 mb-2">Clone with HTTPS:</p>
